 ...
 *
 * Usage:
 * $log = new Logger('/var/log/', KLogger::INFO);
...
class Logger {
	 ...
	 * @return Logger
	 */
	public static function getInstance($logDirectory = false, $severity = false, $name = '') {
		if (!self::$instances[$logDirectory . $severity . $name]) {
			self::$instances[$logDirectory . $severity . $name] = new self($logDirectory, $severity, $name);
		}

		return self::$instances[$logDirectory . $severity . $name];
	}
	 ...
	 * @return void
	 */
	public function __construct($logDirectory, $severity, $name = '') {
